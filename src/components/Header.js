      ...
      <div className="header">
        <Container maxWidth='xl'>
          <nav className="header__navbar">
            <img className="navbar__logo" src="img/touchme-logo.png" alt="Logo" />

            {/* Links desktop */}
            <div className="navbar__links">
              <Button variant='text' color='inherit'>Acerca</Button>
              <Button variant='text' color='inherit'>Soporte</Button>
              <Button variant='text' color='inherit'>Descarga</Button>
